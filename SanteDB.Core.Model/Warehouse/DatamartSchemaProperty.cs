...
namespace SanteDB.Core.Model.Warehouse
{
    ...
    /// </summary>
    [XmlType(nameof(DatamartSchemaProperty), Namespace = "http://santedb.org/warehousing"), JsonObject(nameof(DatamartSchemaProperty))]
    ...
    /// </summary>
    [XmlType(nameof(SchemaPropertyAttributes), Namespace = "http://santedb.org/warehousing"), Flags]
    ...
    /// Identifies the type which a schema property carries
    /// </summary>
    [XmlType(nameof(SchemaPropertyType), Namespace = "http://santedb.org/warehousing")]
